    ...
    <div className="w-80 shrink-0 border-r border-border overflow-y-auto">
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-3">
          <Label className="text-sm font-medium">{t('common:changelog.sourceLabel')}</Label>
          <RadioGroup
            value={sourceMode}
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-sm">
                    {t(`common:changelog.sourceModes.${sourceMode === 'tasks' ? 'tasks' : sourceMode === 'git-history' ? 'gitHistory' : 'branchDiff'}`)}
                  </span>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {t(`common:changelog.sourceModeDescriptions.${sourceMode === 'tasks' ? 'tasks' : sourceMode === 'git-history' ? 'gitHistory' : 'branchDiff'}`)}
                </p>
              </div>
            </label>
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-sm">
                    {t('common:changelog.sourceModes.gitHistory')}
                  </span>
                </div>
                <p className="text-xs text-muted-foreground mt-1">
                  {t('common:changelog.sourceModeDescriptions.gitHistory')}
                </p>
              </div>
            </label>
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-sm">
                    {t('common:changelog.sourceModes.branchDiff')}
                  </span>
                </div>
                <p className="text-xs text-muted-foreground mt-1">
                  {t('common:changelog.sourceModeDescriptions.branchDiff')}
                </p>
              </div>
            </label>
          </RadioGroup>
        ...
        {sourceMode === 'git-history' && (
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm">{t('common:changelog.gitOptions')}</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {gitHistoryType === 'recent' && (
                <div className="space-y-2">
                  <Label className="text-xs">{t('common:changelog.numCommits')}</Label>
                  <Input
                    type="number"
                    min={1}
                    max={500}
                ...
                <>
                  <div className="space-y-2">
                    ...
                    <Select value={gitHistoryFromTag} onValueChange={onGitHistoryFromTagChange}>
                      <SelectTrigger>
                        <SelectValue placeholder={t('common:selection.select')} />
                      </SelectTrigger>
                      <SelectContent>
                        {tags.map((tag) => (
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs">{t('common:changelog.toTag')}</Label>
              ...
              >
                {isLoadingCommits ? (
                  <>
                    ...
                    {t('common:changelog.loadingCommits')}
                  </>
                ) : (
                  <>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  {t('common:changelog.baseBranchHelp')}
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  {t('common:changelog.compareBranchHelp')}
                </p>
              </div>
