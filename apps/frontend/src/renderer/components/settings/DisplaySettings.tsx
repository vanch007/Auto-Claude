        ...
        <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              {displayScale !== UI_SCALE_DEFAULT && (
                <button
                  ...
                  title={t('display.resetToDefault')}
                >
          ...
          <div className="flex items-center gap-3 pt-1">
            <button
              ...
              title={t('display.decreaseScale', { step: UI_SCALE_STEP })}
            >
            ...
            <button
              ...
              title={t('display.increaseScale', { step: UI_SCALE_STEP })}
            >
            ...
            <button
              ...
              title={t('display.applyScaleChanges')}
            >
              <Check className="h-4 w-4" />
              <span className="text-sm font-medium">{t('common:actions.apply')}</span>
            </button>
          </div>
